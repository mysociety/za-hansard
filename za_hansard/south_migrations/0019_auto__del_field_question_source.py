...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('za_hansard_question', 'source')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Question.source'
        raise RuntimeError("Cannot reverse this migration. 'Question.source' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Question.source'
        db.add_column('za_hansard_question', 'source',

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'za_hansard_question', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('answer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='question', null=True, to=orm['za_hansard.Answer'])),
        ...
        db.send_create_signal(u'za_hansard', ['Question'])

        # Adding model 'Answer'
        db.create_table(u'za_hansard_answer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'za_hansard', ['Answer'])


    def backwards(self, orm):
        # Deleting model 'Question'
        db.delete_table(u'za_hansard_question')

        # Deleting model 'Answer'
        db.delete_table(u'za_hansard_answer')

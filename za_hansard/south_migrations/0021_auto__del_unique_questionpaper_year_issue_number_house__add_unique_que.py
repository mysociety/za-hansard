...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'QuestionPaper', fields ['year', 'issue_number', 'house']
        db.delete_unique('za_hansard_questionpaper', ['year', 'issue_number', 'house'])

        # Adding unique constraint on 'QuestionPaper', fields ['year', 'issue_number', 'house', 'parliament_number']
        db.create_unique('za_hansard_questionpaper', ['year', 'issue_number', 'house', 'parliament_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuestionPaper', fields ['year', 'issue_number', 'house', 'parliament_number']
        db.delete_unique('za_hansard_questionpaper', ['year', 'issue_number', 'house', 'parliament_number'])

        # Adding unique constraint on 'QuestionPaper', fields ['year', 'issue_number', 'house']
        db.create_unique('za_hansard_questionpaper', ['year', 'issue_number', 'house'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Answer.last_sayit_import'
        db.add_column(u'za_hansard_answer', 'last_sayit_import',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Answer.sayit_section'
        db.add_column(u'za_hansard_answer', 'sayit_section',
    ...
    def backwards(self, orm):
        # Deleting field 'Answer.last_sayit_import'
        db.delete_column(u'za_hansard_answer', 'last_sayit_import')

        # Deleting field 'Answer.sayit_section'
        db.delete_column(u'za_hansard_answer', 'sayit_section_id')

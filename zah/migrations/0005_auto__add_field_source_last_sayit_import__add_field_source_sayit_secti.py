...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'zah_source', 'last_sayit_import',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source.sayit_section'
        db.add_column(u'zah_source', 'sayit_section',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'zah_source', 'last_sayit_import')

        # Deleting field 'Source.sayit_section'
        db.delete_column(u'zah_source', 'sayit_section_id')

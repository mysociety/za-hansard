...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.parliament'
        db.delete_column('za_hansard_question', 'parliament')

        # Deleting field 'Question.session'
        db.delete_column('za_hansard_question', 'session')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Question.parliament'
        raise RuntimeError("Cannot reverse this migration. 'Question.parliament' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Question.parliament'
        db.add_column('za_hansard_question', 'parliament',
        ...
        db.add_column('za_hansard_question', 'session',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)

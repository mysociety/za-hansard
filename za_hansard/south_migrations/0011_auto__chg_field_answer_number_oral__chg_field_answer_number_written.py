...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'za_hansard_answer', 'number_oral', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Answer.number_written'
        db.alter_column(u'za_hansard_answer', 'number_written', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Answer.number_oral'
        db.alter_column(u'za_hansard_answer', 'number_oral', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Answer.number_written'
        db.alter_column(u'za_hansard_answer', 'number_written', self.gf('django.db.models.fields.IntegerField')())

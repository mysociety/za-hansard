...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Question', fields ['oral_number']
        db.create_index('za_hansard_question', ['oral_number'])

        # Adding index on 'Question', fields ['written_number']
        db.create_index('za_hansard_question', ['written_number'])

        # Adding index on 'Question', fields ['president_number']
        db.create_index('za_hansard_question', ['president_number'])

        # Adding index on 'Question', fields ['dp_number']
        db.create_index('za_hansard_question', ['dp_number'])

        # Adding field 'Answer.president_number'
        db.add_column('za_hansard_answer', 'president_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True),
                      keep_default=False)

        # Adding field 'Answer.dp_number'
        db.add_column('za_hansard_answer', 'dp_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True),
                      keep_default=False)

        # Adding unique constraint on 'Answer', fields ['dp_number', 'house', 'year']
        db.create_unique('za_hansard_answer', ['dp_number', 'house', 'year'])

        # Adding unique constraint on 'Answer', fields ['president_number', 'house', 'year']
        db.create_unique('za_hansard_answer', ['president_number', 'house', 'year'])


    def backwards(self, orm):
        # Removing unique constraint on 'Answer', fields ['president_number', 'house', 'year']
        db.delete_unique('za_hansard_answer', ['president_number', 'house', 'year'])

        # Removing unique constraint on 'Answer', fields ['dp_number', 'house', 'year']
        db.delete_unique('za_hansard_answer', ['dp_number', 'house', 'year'])

        # Removing index on 'Question', fields ['dp_number']
        db.delete_index('za_hansard_question', ['dp_number'])

        # Removing index on 'Question', fields ['president_number']
        db.delete_index('za_hansard_question', ['president_number'])

        # Removing index on 'Question', fields ['written_number']
        db.delete_index('za_hansard_question', ['written_number'])

        # Removing index on 'Question', fields ['oral_number']
        db.delete_index('za_hansard_question', ['oral_number'])

        # Deleting field 'Answer.president_number'
        db.delete_column('za_hansard_answer', 'president_number')

        # Deleting field 'Answer.dp_number'
        db.delete_column('za_hansard_answer', 'dp_number')

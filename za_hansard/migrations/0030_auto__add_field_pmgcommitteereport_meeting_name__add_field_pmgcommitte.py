...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PMGCommitteeReport.meeting_name'
        db.add_column(u'za_hansard_pmgcommitteereport', 'meeting_name',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PMGCommitteeReport.committee_url'
        db.add_column(u'za_hansard_pmgcommitteereport', 'committee_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PMGCommitteeReport.committee_name'
        db.add_column(u'za_hansard_pmgcommitteereport', 'committee_name',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'PMGCommitteeReport.meeting_date'
        db.add_column(u'za_hansard_pmgcommitteereport', 'meeting_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PMGCommitteeReport.meeting_name'
        db.delete_column(u'za_hansard_pmgcommitteereport', 'meeting_name')

        # Deleting field 'PMGCommitteeReport.committee_url'
        db.delete_column(u'za_hansard_pmgcommitteereport', 'committee_url')

        # Deleting field 'PMGCommitteeReport.committee_name'
        db.delete_column(u'za_hansard_pmgcommitteereport', 'committee_name')

        # Deleting field 'PMGCommitteeReport.meeting_date'
        db.delete_column(u'za_hansard_pmgcommitteereport', 'meeting_date')

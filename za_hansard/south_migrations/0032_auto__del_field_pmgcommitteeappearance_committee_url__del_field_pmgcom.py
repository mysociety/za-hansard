...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PMGCommitteeAppearance.committee_url'
        db.delete_column(u'za_hansard_pmgcommitteeappearance', 'committee_url')

        # Deleting field 'PMGCommitteeAppearance.meeting_date'
        db.delete_column(u'za_hansard_pmgcommitteeappearance', 'meeting_date')

        # Deleting field 'PMGCommitteeAppearance.committee'
        db.delete_column(u'za_hansard_pmgcommitteeappearance', 'committee')

        # Deleting field 'PMGCommitteeAppearance.meeting'
        db.delete_column(u'za_hansard_pmgcommitteeappearance', 'meeting')


    def backwards(self, orm):
        # Adding field 'PMGCommitteeAppearance.committee_url'
        db.add_column(u'za_hansard_pmgcommitteeappearance', 'committee_url',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'PMGCommitteeAppearance.meeting_date'
        db.add_column(u'za_hansard_pmgcommitteeappearance', 'meeting_date',
                      self.gf('django.db.models.fields.DateField')(default=''),
                      keep_default=False)

        # Adding field 'PMGCommitteeAppearance.committee'
        db.add_column(u'za_hansard_pmgcommitteeappearance', 'committee',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'PMGCommitteeAppearance.meeting'
        db.add_column(u'za_hansard_pmgcommitteeappearance', 'meeting',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        for pca in orm['za_hansard.PMGCommitteeAppearance'].objects.all():
            pcr = pca.report
            for pca_field_name, pcr_field_name in self.field_name_mapping:
                setattr(pca, pca_field_name, getattr(pcr, pcr_field_name))
                pca.save()
    ...
    models = {
        ...
        u'za_hansard.pmgcommitteereport': {
            ...
            'committee_name': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'committee_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_sayit_import': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'meeting_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'meeting_name': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),

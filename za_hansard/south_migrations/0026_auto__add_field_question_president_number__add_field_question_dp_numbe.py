...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.president_number'
        db.add_column('za_hansard_question', 'president_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Question.dp_number'
        db.add_column('za_hansard_question', 'dp_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding unique constraint on 'Question', fields ['dp_number', 'house', 'year']
        db.create_unique('za_hansard_question', ['dp_number', 'house', 'year'])

        # Adding unique constraint on 'Question', fields ['president_number', 'house', 'year']
        db.create_unique('za_hansard_question', ['president_number', 'house', 'year'])

        # Adding index on 'Answer', fields ['written_number']
        db.create_index('za_hansard_answer', ['written_number'])

        # Adding index on 'Answer', fields ['url']
        db.create_index('za_hansard_answer', ['url'])

        # Adding index on 'Answer', fields ['house']
        db.create_index('za_hansard_answer', ['house'])

        # Adding index on 'Answer', fields ['year']
        db.create_index('za_hansard_answer', ['year'])

        # Adding index on 'Answer', fields ['processed_code']
        db.create_index('za_hansard_answer', ['processed_code'])

        # Adding index on 'Answer', fields ['oral_number']
        db.create_index('za_hansard_answer', ['oral_number'])


    def backwards(self, orm):
        # Removing index on 'Answer', fields ['oral_number']
        db.delete_index('za_hansard_answer', ['oral_number'])

        # Removing index on 'Answer', fields ['processed_code']
        db.delete_index('za_hansard_answer', ['processed_code'])

        # Removing index on 'Answer', fields ['year']
        db.delete_index('za_hansard_answer', ['year'])

        # Removing index on 'Answer', fields ['house']
        db.delete_index('za_hansard_answer', ['house'])

        # Removing index on 'Answer', fields ['url']
        db.delete_index('za_hansard_answer', ['url'])

        # Removing index on 'Answer', fields ['written_number']
        db.delete_index('za_hansard_answer', ['written_number'])

        # Removing unique constraint on 'Question', fields ['president_number', 'house', 'year']
        db.delete_unique('za_hansard_question', ['president_number', 'house', 'year'])

        # Removing unique constraint on 'Question', fields ['dp_number', 'house', 'year']
        db.delete_unique('za_hansard_question', ['dp_number', 'house', 'year'])

        # Deleting field 'Question.president_number'
        db.delete_column('za_hansard_question', 'president_number')

        # Deleting field 'Question.dp_number'
        db.delete_column('za_hansard_question', 'dp_number')
    ...
    models = {
        ...
        'za_hansard.question': {
            ...
            'dp_number': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'house': ('django.db.models.fields.CharField', [], {'max_length': '1', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'president_number': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
